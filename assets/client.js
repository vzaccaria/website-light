...
/***/ function(module, exports, __webpack_require__) {
	...
	var _debug2 = __webpack_require__(171);
	
	var _debug3 = _interopRequireDefault(_debug2);
	
	var _sidebar = __webpack_require__(174);
	
	_debug3['default'].enable('app:*');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sidebarTemplate = __webpack_require__(175);
	
	module.exports = { createSidebarComponentHTML: sidebarTemplate };

/***/ },
/* 175 */
/***/ function(module, exports, __webpack_require__) {

	var jade = __webpack_require__(176);
	...
	jade_mixins["sidebar__link_item"] = jade_interp = function(icon, name, link){
	var block = (this && this.block), attributes = (this && this.attributes) || {};
	buf.push("<li" + (jade.attr("onclick", "location.href='" + (link) + "'", true, false)) + " style=\"cursor: pointer\" class=\"sidebar__link_item\"><span class=\"sidebar__link_item__icon fa-stack\"><i class=\"fa fa-stack-2x fa-circle\"></i><i" + (jade.cls(['sidebar__link_item__icon__inner','fa','fa-stack-1x','fa-inverse',icon], [null,null,null,null,true])) + "></i></span><div class=\"sidebar__link_item__name\">" + (jade.escape(null == (jade_interp = name) ? "" : jade_interp)) + "</div></li>");
	};
	buf.push("<div class=\"sidebar\"><img" + (jade.attr("src", __webpack_require__(178), true, false)) + " class=\"sidebar__picture\"/><div class=\"sidebar__name\">Vittorio Zaccaria</div><div class=\"sidebar__address\">Politecnico di Milano</div><ul class=\"sidebar__link_list\">");
	jade_mixins["sidebar__link_item"]('fa-home'           , 'Home'     , baseUrl + "/");
	jade_mixins["sidebar__link_item"]('fa-flask'          , 'Research' , baseUrl + "/research.html");
	jade_mixins["sidebar__link_item"]('fa-quote-left'     , 'Blog'     , baseUrl + "/blog.html");
	jade_mixins["sidebar__link_item"]('fa-floppy-o'       , 'Projects' , baseUrl + "/projects.html");
	jade_mixins["sidebar__link_item"]('fa-graduation-cap' , 'Teaching' , baseUrl + "/teaching.html");
	jade_mixins["sidebar__link_item"]('fa-user'           , 'CV'       , baseUrl + "/deposit/cv.pdf");
	jade_mixins["sidebar__link_item"]('fa-youtube-play'   , 'Videos'   , baseUrl + "/videos.html");
	jade_mixins["sidebar__link_item"]('fa-map-marker'     , 'Address'  , baseUrl + "/address.html");
	buf.push("</ul><div class=\"sidebar__bottom\"><div onclick=\"location.href='http://www.linkedin.com/in/vzaccaria'\" style=\"cursor: pointer\" class=\"sidebar__bottom__button\"><i class=\"fa fa-linkedin-square\"></i></div><div onclick=\"location.href='http://twitter.com/_vzaccaria_'\" style=\"cursor: pointer\" class=\"sidebar__bottom__button\"><i class=\"fa fa-twitter-square\"></i></div><div onclick=\"location.href='https://plus.google.com/116322227495215922957/about'\" style=\"cursor: pointer\" class=\"sidebar__bottom__button\"><i class=\"fa fa-google-plus-square\"></i></div></div></div>");}.call(this,"baseUrl" in locals_for_with?locals_for_with.baseUrl:typeof baseUrl!=="undefined"?baseUrl:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.rethrow = function rethrow(err, filename, lineno, str){
	  ...
	  try {
	    str = str || __webpack_require__(177).readFileSync(filename, 'utf8')
	  } catch (ex) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "c6cf13019dcd9746d94b5118e0436b17.jpg"
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/style-loader/index.js!./../../node_modules/css-loader/index.js!./fonts.css", function() {
				var newContent = require("!!./../../node_modules/style-loader/index.js!./../../node_modules/css-loader/index.js!./fonts.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, "@import url(http://fonts.googleapis.com/css?family=Ubuntu+Mono:400,700);", ""]);
